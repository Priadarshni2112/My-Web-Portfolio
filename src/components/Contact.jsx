        ...
        <div name="Contact" className="w-full h-screen text-black bg-gradient-to-l from-purple-200 via-sky-100 to-slate-50 dark:bg-gradient-to-b dark:from-black dark:to-gray-800 p-4 dark:text-white">
          <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/bdrrepzb" method="POST" className="flex flex-col w-full md:w-1/2">
                    <input type="text" 
                    name="name" 
                ...
                <textarea name="message" placeholder="Enter your message" rows="10" className="p-2 bg-transparent border-black border-2 rounded-md text-black dark:border-white focus:outline-none"/>
